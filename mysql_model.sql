...
`a_status` int(11) NULL DEFAULT NULL,
...
MIN_ROWS = 0
ROW_FORMAT = Dynamic;
CREATE TABLE `d_article_catorgery_relationship` (
...
MIN_ROWS = 0
ROW_FORMAT = Dynamic;
CREATE TABLE `d_catorgery` (
`cat_id` int(11) NOT NULL AUTO_INCREMENT,
`cat_name` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
`cat_parentid` int(11) NULL DEFAULT NULL,
`cat_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
`u_status` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
...
ALTER TABLE `d_article_catorgery_relationship` ADD CONSTRAINT `fk_d_article_catorgery_relationship_d_article_catorgery_relatio1` FOREIGN KEY (`a_id`) REFERENCES `d_article` (`a_id`) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE `d_article_catorgery_relationship` ADD CONSTRAINT `fk_d_article_catorgery_relationship_d_article_catorgery_relatio2` FOREIGN KEY (`cat_id`) REFERENCES `d_catorgery` (`cat_id`) ON DELETE CASCADE ON UPDATE CASCADE;
