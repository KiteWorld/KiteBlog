let sql = {
	...
	updateHotPoint: "UPDATE k_hot_point SET hp_content = ?, hp_pictrue = ?, hp_createdate = ?, hp_type = ?, u_id = ?, cat_id = ? WHERE hp_id = ?",
	deleteHotPoint: "delete from k_hot_point where hp_id in (?)",
	insertHotPoint: "insert into k_hot_point (hp_content,hp_pictrue,hp_createdate,hp_type,u_id,cat_id) values(?,?,?,?,?,?)",
